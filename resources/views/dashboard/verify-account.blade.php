                                    ...
                                    <div class="nk-block-head-content text-center">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Valid identity card. (e.g. Drivers license,
                                                ...
                                                <form class="deposit-form" method="post" action="{{ url('/upload-kyc')}}" enctype="multipart/form-data">         
                                                    {{csrf_field()}}
                          
                                                    <center><p class="title1 text-success" style="color: green">Upload image</p></center>
                                                    <div class="input-group input-text-select mb-3">
                                                        
                                                        <p class="title1 text-success" style="color: green">Select Front</p>
                                                        <input type="file" name="card"  class="form-control crypt-input-lg" required>
                                                       
                                                        
                                                      </div>
                                                      <div class="input-group input-text-select mb-3">
                                                        <p class="title1 text-success" style="color: green">Select Back</p>
                                                      <input type="file" name="pass"  class="form-control crypt-input-lg" required>
                                                    </div>
                
                                                    <input type="submit" name="" style="background-color: green" class="crypt-button-green-full mt-2"
                                                           value="Click Here To Upload KYC">
                                                </form>
