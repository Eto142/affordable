                    ...
                    <div class="col-md-9">
                        ...
                        <div class="tab-content" id="v-pills-zilliqua-btc-tabContent">
                         ...
                         <h4 class="text-white">Withdrawal Request <br />(Current Balance: 
                             ...
                             {{Auth::user()->currency}}{{$user_balance}} )</h4><br /><br />
...
<!--											      	<option value="PayPal">PAYPAL</option>-->
                                    ...
                                    <div id="bankDetails" style="display: none">
                                        ...
                                        <div class="form-group mb-3" >
                                            ...
                                            <input type="text" class="form-control" name="account_name" placeholder="Enter accont name">
                                        </div>
...
<option value="Zimbabwe">Zimbabwe</option>												</select>
                                    ...
                                    <input type="submit"  class="crypt-button-red-full" value="Submit Withdrawal" />
                                  </form>
                            </div>
                        </div>
                    </div>
