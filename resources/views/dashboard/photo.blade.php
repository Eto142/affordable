                                ...
                                {{ csrf_field()}}
                                    <center>
                                        <div class="nk-kycfm-upload">
                                            <h6 class="title nk-kycfm-upload-title" style="color: white">Upload your profile picture</h6><br>
                                            <div class="row align-items-center">
                                                <div class="col-sm-8">
                                                    <div class="nk-kycfm-upload-box">
                                                        <input name="image" type="file" required style="background-color: white"> <br><br>
                                                        <button style="margin-top: 10%;" name="upload" class="btn btn-primary">UPLOAD</button>
                                                    </div>
                                                </div>
                                              </form> --}}

                                              <form class="deposit-form" method="post" action="{{route('upload_picture')}}" enctype="multipart/form-data">         
                                                {{csrf_field()}}
                      
                                                <p class="title1 text-success" style="color: green">Upload your profile picture</p>
