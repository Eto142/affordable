...
<head>
    ...
    <title>Affordableinvprogram</title>
                                    ...
                                    <td align='center' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                        ...
                                        <p style='line-height: 24px; margin-bottom:20px;'>
                                            Connect with our media personnel if you are running into problems at
                                             <a href='mailto:support@affordableinvprogram.com' style='color: blue; font-size: 20px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;'>support@affordableinvprogram.com </a>
                                        </p>
                                        <br/> 
                                        <p style='line-height: 24px'>
                                            Kind Regards,</br>
                                            Affordableinvprogram
                                        </p>
