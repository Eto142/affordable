        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    ...
                    <p class="footer-link">
                        Are you looking for a stable, reliable, guaranteed weekly income? Affordableinvprogram offers a range of options to make the most of your investment. Get involved to discover the power of copy trading.
                    </p>
                </div>
                <div class="col-lg-4 mb-4">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="text-muted mb-0">© 2026 Affordableinvprogram. All rights reserved.</p>
                </div>
